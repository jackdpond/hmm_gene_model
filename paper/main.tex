...
\begin{figure}
    ...
    \caption{Distributional differences in the time series of periodic and non-periodic transcripts. A (left): A PCA plot of individual transcripts by their arcsinh-transformed relative intensities across timesteps. B (right): A similar plot, using the time-relativized (Z-scored) versions of those values.}
