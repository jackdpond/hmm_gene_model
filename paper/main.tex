...
In this paper, we use a time series transcriptomic dataset \cite{Tu2005} to investigate a yeast population undergoing spontaneous, synchronized metabolic oscillations. We independently determine the period of the metabolic cycle and identify distinct transcriptional components involved in the cycle. We also interpret these components using text annotations on each distinct transcript measured. Our investigation validates conclusions by \cite{Tu2005} and provides new insights, while highlighting advantages and drawbacks of various data analysis techniques on this high-dimensional, periodic dataset.
...
\begin{figure}
    \includegraphics[scale=0.5]{figures/redone_metabolic_state.png}
...
\begin{figure}
    ...
    \caption{Left: Projection to two principal components of 200-dimensional time-steps, colored by GMM assignment and connected in order. The clusters and cycle are clear. Right: GMM cluster assignments over time--the 12-time-step period is clear.}
\end{figure}
