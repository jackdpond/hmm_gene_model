...
\title{Illuminating a High Dimensional Biological Cycle}
...
apply several data dimension reduction and analysis techniques on a buddying yeast $\textit{Saccharomyces Cerecisiae}$ transcriptome dataset. These data, which consist of a total RNA transcriptome of a budding yeast cell prepared at ~25 minute intervals, provide insight into how the transcriptome of yeast changes temporally. Specifically, our analysis attempts to use various techniques to determine the period of respiratory bursts in a synchronized yeast population's metabolic cycle and to determine which genes 
